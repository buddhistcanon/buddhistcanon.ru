            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-8">
                                <Menu as="div" class="relative inline-block text-left">
                                    <MenuButton
                                        class="inline-flex w-full justify-center text-gray-700 bg-gray-100 hover:bg-gray-200 hover:text-gray-900 border border-gray-200 px-3 py-2 rounded-xl text-sm font-medium">
                                        Палийский канон
                                        <ChevronDownIcon
                                    ...
                                    >
                                        <MenuItems
                                            class="absolute right-0 mt-2 w-56 py-1 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        ...
                        <div class="hidden md:block">
                            <div class="flex flex-row">
                                <div
                                    class="border border-gray-200 bg-gray-100 px-3 py-2 rounded-xl text-sm font-medium ml-8 flex flex-row items-center">
                                    A
                                    <ArrowUpIcon class="h-3 w-3"/>
                                </div>
                                <div
                                    class="border border-gray-200 bg-gray-100 px-3 py-2 rounded-xl text-sm font-medium ml-4 flex flex-row items-center">
                                    A
                    ...
                    <div class="md:hidden flex flex-row">
                        <div
                            class="bg-gray-100 px-3 py-1 rounded-xl text-sm font-medium mr-4 flex flex-row items-baseline">
                            A
                            <ArrowUpIcon class="h-3 w-3"/>
                        </div>
                        <div
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div v-if="!$page.props.auth.user">
                                <Link href="/login"
                                      class="mr-4 text-gray-700 bg-gray-100 hover:bg-gray-200 hover:text-gray-900 border border-gray-200 px-3 py-2 rounded-xl text-sm font-medium">
                                    Вход
                                </Link>
                ...
                <div class="border-t border-gray-400 pt-4 pb-3">
                    <div v-if="!$page.props.auth.user">
                        <DisclosureButton :as="Link" :method="get" :href="'/login'"
                                          class="block rounded-md px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-700 hover:text-gray-800">
                            Вход
                        </DisclosureButton>
                    </div>
                    <div v-else>
