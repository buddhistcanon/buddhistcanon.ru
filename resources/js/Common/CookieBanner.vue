...
<template>
    <transition name="slide">
        <div v-if="!consent"
            class="fixed bottom-0 w-full py-4 px-4 md:px-10 text-center text-white bg-gray-800 flex flex-col md:flex-row">
            <div>
                ...
                <a href="https://www.kaspersky.ru/resource-center/definitions/cookies" target="_blank"
                    class="underline">здесь</a>.
            </div>
            <div>
