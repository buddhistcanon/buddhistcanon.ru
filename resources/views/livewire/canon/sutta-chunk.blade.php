<div class="flex flex-row py-2 @if($numColumns>1) pr-4 @endif"
     x-data="{show_controls: false, open_dropdown: false}" x-on:mouseover="show_controls = true" x-on:mouseout="show_controls = false">
    <div class="w-4 mr-1" >
        <div x-show="show_controls" style="display: none">
            <div @keydown.escape="open_dropdown = false" @click.away="open_dropdown = false" class="relative inline-block text-left">
                <div>
