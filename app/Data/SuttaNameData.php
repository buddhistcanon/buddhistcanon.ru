...
class SuttaNameData extends Data
{
    ...
    public static function fromString(string $string): self
    {
        ...
        if(!isset($match[1])) throw new WrongSuttaNameException("$string is not valid sutta name");
        $category = $match[1];
        ...
        if(!$orders) throw new WrongSuttaNameException("$string is not valid sutta name");
