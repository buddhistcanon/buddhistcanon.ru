    ...
    foreach ($routesExpected as $routeExpected) {
        if (strpos($routeExpected, "*") !== false) {
            ...
            if (strpos($routeExpected, "*") !== 0) {
                ...
                if (strpos($currentRouteName, $routeExpected) === 0) return $classForActive; else return $classForNonactive;
            } else {
            ...
            if ($currentRouteName === $routeExpected) return $classForActive; else return $classForNonactive;
        }
    }
}
