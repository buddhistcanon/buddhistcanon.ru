...
//            dump(Str::substr($this->content, 0, 20));
            ...
            if($title){
                $chunksPali[] = ""; $chunksEnglish[] = ""; $chunksRussian[] = "## $title";
            }
...
//                    }
                ...
                $chunksPali[] = $chunkPali; $chunksEnglish[] = $chunkEnglish; $chunksRussian[] = $chunkRussian;
    ...
    {
    	if($include) $this->content = mb_substr($this->content, mb_strpos($this->content, $needle));
        else $this->content = mb_substr($this->content, mb_strpos($this->content, $needle) + mb_strlen($needle));
    }
